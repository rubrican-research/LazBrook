...
{LAZBROOK ID}
type
    TLazBrookVersions = (lzbrVer01, lzbrVer02, lzbrVer03, lzbrVer04, lzbrVer05);
const
    LAZBROOK_VER_NAMES: array[TLazBrookVersions] of shortstring = (
            '01',
            '02',
            '03',
            '04',
    ...
    LAZBROOK_LIB     = 'LazBrook';
    LAZBROOK_VERSION = lzbrVer01;   // April 2025
    function LAZBROOK_ID: string;
...
const
    ...
    LAZBROOK_USER_AGENT         = 'LazBrook/1.0';
...
function LAZBROOK_ID: string;
begin
    Result := CONCAT(LAZBROOK_LIB, ' ' , LAZBROOK_VER_NAMES[lzbrVer01]);
end;
