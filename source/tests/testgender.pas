...
begin
  Result := getGenderDef(ISO693_Chinese, @initGenderDefZH);
end;

function gendersJA: TGenderDef;
begin
  Result := getGenderDef(ISO693_Japanese, @initGenderDefJA);
end;

function gendersKO: TGenderDef;
begin
  Result := getGenderDef(ISO693_Korean, @initGenderDefKO);
end;

function gendersAR: TGenderDef;
begin
  Result := getGenderDef(ISO693_Arabic, @initGenderDefAR);
end;

function gendersRU: TGenderDef;
begin
  Result := getGenderDef(ISO693_Russian, @initGenderDefRU);
end;

function gendersHE: TGenderDef;
begin
  Result := getGenderDef(ISO693_Hebrew, @initGenderDefHE);
end;

function gendersUK: TGenderDef;
begin
  Result := getGenderDef(ISO693_Ukrainian, @initGenderDefUK);
end;
